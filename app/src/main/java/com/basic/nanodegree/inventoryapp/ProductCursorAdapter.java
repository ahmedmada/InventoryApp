package com.basic.nanodegree.inventoryapp;
...
public class ProductCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        final String name = cursor.getString(cursor.getColumnIndexOrThrow(ProductContract.ProductEntry.COLUMN_PRODUCT_NAME));
        final String imagePath = cursor.getString(cursor.getColumnIndexOrThrow(ProductContract.ProductEntry.COLUMN_PRODUCT_IMAGE));
        final Integer quantity = cursor.getInt(cursor.getColumnIndexOrThrow(ProductContract.ProductEntry.COLUMN_PRODUCT_QUANTITY));
        final Float price = cursor.getFloat(cursor.getColumnIndexOrThrow(ProductContract.ProductEntry.COLUMN_PRODUCT_PRICE));
        tvName.setText(name);
        ...
        sellButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (view != null) {
                    ...
                    values.put(ProductContract.ProductEntry.COLUMN_PRODUCT_QUANTITY, quantity >= 1? quantity-1: 0);
                    values.put(ProductContract.ProductEntry.COLUMN_PRODUCT_PRICE, price);

                    Uri currentPetUri = ContentUris.withAppendedId(ProductContract.ProductEntry.CONTENT_URI, Integer.parseInt(st));
        ...
        Object obj = cursor.getInt(cursor.getColumnIndex(ProductContract.ProductEntry._ID));
